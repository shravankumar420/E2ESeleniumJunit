...
public class OfferPage {
	...
	public WebElement learnMoreAbout(String section,String name) {
		return driver.findElement(By.xpath("//*[contains(text(),'Learn more about')]/a[contains(text(),'"+section+"')]//following::*[text()='"+name+"']"));
	}
	...
	public WebElement select(String name) {
		if(name.contains(" ")) {
			...
			return driver.findElement(By.xpath("//*[text()='"+name+"']/following::*[@id='Search"+before+capafter+"Id']"));
		}
		else {
